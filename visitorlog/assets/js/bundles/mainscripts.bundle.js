...
$.AdminCompass.leftSideBar = {
    activate: function() {
        ...
        $(window).on("click", function(e) {
            ...
            !a.hasClass("bars") && t.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar") || r.fadeOut(), s.removeClass("overlay-open"))
        }),
...
$.AdminCompass.rightSideBar = {
    activate: function() {
        ...
        $(window).on("click", function(e) {
            var a = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()),
            !a.hasClass("js-right-sidebar") && t.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || r.fadeOut(), s.removeClass("open"))
        }),
...
var Tawk_API = Tawk_API || {}, Tawk_LoadStart = new Date; ! function() {
    ...
    function a() {
        ...
        e && $("#element").text("Element: " + e.localName + (e.id ? "#" + e.id : "")),
