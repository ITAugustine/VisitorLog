/**
 * VendorScripts bundle js - 1.0
 * https://github.com/Aasrith22/frosthacks-project?ysclid=mg9cl1yiz6215240738
 *
 */
! function(a) {
    a.fn.extend({
            ...
            return this.each(function() {
                ...
                if (u.parent().hasClass(d.wrapperClass)) {
                    ...
                    if (z = u.closest("." + d.barClass), y = u.closest("." + d.railClass), f(), a.isPlainObject(b)) {
                        ...
                        if ("scrollBy" in  b) v += parseInt(d.scrollBy);
                        else
                        if ("destroy" in  b) return z.remove(),
                        y.remove(),
                        void u.unwrap();
                        e(v, !1, !0)
                    }
                } else
                if (! (a.isPlainObject(b) && "destroy" in  b)) {
                    ...
                    u.parent().append(z),
                    u.parent().append(y),
                    d.railDraggable && z.bind("mousedown", function(b) {
                        var c = a(document);
                        return k = !0,
...
function(a, b) {
    ...
    k.attach = function(a, b) {
        ...
        b = b ? " " + b : "";
        for (var c, d, f = 0, g = a.length; f < g; f++) c = a[f],
    ...
    k.ripple = function(a, b) {
        ...
        var c = a.length;
        if (b = b || {},
        b.wait = b.wait || 0, b.position = b.position || null, c) for (var d, g, h, i = {}, j = 0, k = {
            type: "mousedown",
            button: 1
