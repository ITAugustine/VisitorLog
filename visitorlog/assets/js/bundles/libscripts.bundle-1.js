...
!function(e, t) {
    ...
    C.extend = C.fn.extend = function() {
        ...
        a++), "object" == typeof s || C.isFunction(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in  e) n = s[t],
        s !== (i = e[t]) && (u && i && (C.isPlainObject(i) || (r = Array.isArray(i))) ? (o = r ? (r = !1, n && Array.isArray(n) ? n : []) : n && C.isPlainObject(n) ? n : {},
    ...
    C.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (_(Object(e)) ? C.merge(n, "string" == typeof e ? [e] : e) : l.call(n, e)),
            n
        },
    ...
    var b = function(n) {
        ...
        function oe(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : y) !== T && E(t), t = t || T, x)) {
                if (11 !== h && (l = G.exec(e))) if (r = l[1]) {
                    ...
                    if (f && (s = f.getElementById(r)) && v(t, s) && s.id === r) return n.push(s),
                    n
                } else {
                    if (l[2]) return O.apply(n, t.getElementsByTagName(e)),
                    n;
                ...
                CHILD: function(p, e, t, g, m) {
                    ...
                    return 1 === g && 0 === m ? function(e) {
                        ...
                        if (c) {
                            ...
                            if (h && (d = a = (i = (r = (o = (s = e)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === S && i[1]), !1 === d) for (;
        ...
        function ye(a, e, t) {
            ...
            return e.first ? function(e, t, n) {
                ...
                for (; e = e[l];) if (1 === e.nodeType || f) if (r = (o = e[C] || (e[C] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), u && u === e.nodeName.toLowerCase()) e = e[l] || e;
                else {
        ...
        function we(d, p, g, m, v, e) {
            ...
            ae(function(e, t, n, i) {
                ...
                } else h = be(h === t ? h.splice(u, h.length) : h),
        ...
        function Ee(e) {
            ...
            s, !0), c = [function(e, t, n) {
                ...
                return r = null,
                i
            }]; a < i; a++) if (t = b.relative[e[a].type]) c = [ye(_e(c), t)];
            else {
        ...
        g = oe.select = function(e, t, n, i) {
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (r = V.needsContext.test(e) ? 0 : o.length; r--&&(s = o[r], !b.relative[a = s.type]);) if ((l = b.find[a]) && (i = l(s.matches[0].replace(Z, ee), J.test(o[0].type) && ge(t.parentNode) || t))) {
                    if (o.splice(r, 1), !(e = i.length && ve(o))) return O.apply(n, i),
                    n;
                    break
                }
            }
    ...
    (C.fn.init = function(e, t, n) {
        ...
        if (i[1]) {
            if (t = t instanceof C ? t[0] : t, C.merge(this, C.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), A.test(i[1]) && C.isPlainObject(t)) for (i in  t) C.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
                        ...
                        return function() {
                            ...
                            e = function() {
                                ...
                                if (! (r < l)) {
                                    ...
                                    C.isFunction(t) ? a ? t.call(e, u(l, o, F, a), u(l, o, q, a)) : (l++, t.call(e, u(l, o, F, a), u(l, o, q, a), u(l, o, F, o.notifyWith))) : (s !== F && (n = void 0, i = [e]), (a || o.resolveWith)(n, i))
                                }
                            },
                            t = a ? e : function() {
                                try {
...
//            throw e
    ...
    var U = function(e, t, n, i, r, o, s) {
        ...
        if (void 0 !== i && (r = !0, C.isFunction(i) || (s = !0), u && (t = s ? (t.call(e, i), null) : (u = t, function(e, t, n) {
            return u.call(C(e), n)
    ...
    var Q = new $, V = new $, z = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Y = /[A-Z]/g; function X(e, t, n) {
        var i, r;
    ...
    var fe, he, de = /<|&#?\w+;/; function pe(e, t, n, i, r) {
        for (var o, s, a, l, u, c, f = t.createDocumentFragment(), h = [], d = 0, p = e.length; d < p; d++) if ((o = e[d]) || 0 === o) if ("object" === C.type(o)) C.merge(h, o.nodeType ? [o] : o);
        else
        if (de.test(o)) {
        ...
        for (f.textContent = "", d = 0; o = h[d++];) if (i && -1 < C.inArray(o, i)) r && r.push(o);
        else
        if (u = C.contains(o.ownerDocument, o), s = ue(f.appendChild(o), "script"), u && ce(s), n) for (c = 0; o = s[c++];) ae.test(o.type || "") && n.push(o);
        return f
    }
    ...
    var ge = x.documentElement, me = /^key/, ve = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, ye = /^([^.]*)(?:\.(.+)|)/; function _e() {
        return !0
    }
    function be() {
        return !1
    ...
    C.event = {
        ...
        add: function(t, e, n, i, r) {
            ...
            if (m) for (n.handler && (n = (o = n).handler, r = o.selector), r && C.find.matchesSelector(ge, r), n.guid || (n.guid = C.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0
            }), u = (e = (e || "").match(P) || [""]).length; u--;) d = g = (a = ye.exec(e[u]) || [])[1],
            p = (a[2] || "").split(".").sort(),
            d && (f = C.event.special[d] || {},
            d = (r ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {},
            c = C.extend({
                type: d,
                origType: g,
                data: i,
        ...
        remove: function(e, t, n, i, r) {
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(P) || [""]).length; u--;) if (d = g = (a = ye.exec(t[u]) || [])[1], p = (a[2] || "").split(".").sort(), d) {
                    for (f = C.event.special[d] || {},
                    h = l[d = (i ? f.delegateType : f.bindType) || d] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = h.length; o--;) c = h[o],
                    !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (h.splice(o, 1), c.selector && h.delegateCount--, f.remove && f.remove.call(e, c));
        ...
        handlers: function(e, t) {
            ...
            if (l && u.nodeType && !("click" === e.type && 1 <= e.button)) for (; u !== this; u = u.parentNode || this) if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                for (o = [], s = {},
                n = 0; n < l; n++) void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? -1 < C(r, this).index(u) : C.find(r, this, null, [u]).length),
                s[r] && o.push(i);
                o.length && a.push({
                    elem: u,
                    handlers: o
    ...
    var Te = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi, xe = /<script|<style|<link/i, Ce = /checked\s*(?:[^=]|=\s*.checked.)/i, Se = /^true\/(.*)/, De = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g; function Ae(e, t) {
    ...
    function ke(e, t) {
        var n, i, r, o, s, a, l, u;
        if (1 === t.nodeType) {
            if (Q.hasData(e) && (o = Q.access(e), s = Q.set(t, o), u = o.events)) for (r in  delete s.handle, s.events = {},
            u) for (n = 0, i = u[r].length; n < i; n++) C.event.add(t, r, u[r][n]);
            V.hasData(e) && (a = V.access(e), l = C.extend({},
            a), V.set(t, l))
        }
    }
    function Oe(n, i, r, o) {
        ...
        if (f && (t = (e = pe(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = C.map(ue(e, "script"), Ne)).length; c < f; c++) l = e,
            c !== h && (l = C.clone(l, !0, !0), a && C.merge(s, ue(l, "script"))),
            r.call(n[c], l, c);
            if (a) for (u = s[s.length - 1].ownerDocument, C.map(s, Ie), c = 0; c < a; c++) l = s[c],
            ae.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(u, l) && (l.src ? C._evalUrl && C._evalUrl(l.src) : v(l.textContent.replace(De, ""), u))
        }
        return n
    }
    function Le(e, t, n) {
        for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || C.cleanData(ue(i)),
        i.parentNode && (n && C.contains(i.ownerDocument, i) && ce(ue(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    C.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (! (m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e))) for (s = ue(c), i = 0, r = (o = ue(e)).length; i < r; i++) a = o[i],
            l = s[i],
            void 0,
            "input" === (u = l.nodeName.toLowerCase()) && oe.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t) if (n) for (o = o || ue(e), s = s || ue(c), i = 0, r = o.length; i < r; i++) ke(o[i], s[i]);
            else ke(e, c);
    ...
    var je = /^margin/, He = new RegExp("^(" + G + ")(?!px)[a-z%]+$", "i"), Pe = function(e) {
        var t = e.ownerDocument.defaultView;
        return t && t.opener || (t = T),
        t.getComputedStyle(e)
    }; function Fe(e, t, n) {
        var i, r, o, s, a = e.style;
        return (n = n || Pe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || C.contains(e.ownerDocument, e) || (s = C.style(e, t)), !m.pixelMarginRight() && He.test(s) && je.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)),
        void 0 !== s ? s + "" : s
    }
    function qe(e, t) {
        return {
    ...
    Ue = ["Webkit", "Moz", "ms"], Ke = x.createElement("div").style; function $e(e) {
        var t = C.cssProps[e];
    ...
    function Ve(e, t, n, i, r) {
        var o, s = 0;
        for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2)"margin" === n && (s += C.css(e, n + Z[o], !0, r)),
        i ? ("content" === n && (s -= C.css(e, "padding" + Z[o], !0, r)), "margin" !== n && (s -= C.css(e, "border" + Z[o] + "Width", !0, r))) : (s += C.css(e, "padding" + Z[o], !0, r), "padding" !== n && (s += C.css(e, "border" + Z[o] + "Width", !0, r)));
        return s
    }
    function ze(e, t, n) {
        var i, r = Pe(e),
    ...
    C.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                void 0 === n ? s && "get" in  s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t] : ("string" === (o = typeof n) && (r = J.exec(n)) && r[1] && (n = ne(e, t, r), o = "number"), void(null != n && n == n && ("number" === o && (n += r && r[3] || (C.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in  s && void 0 === (n = s.set(e, n, i)) || (l ? u.setProperty(t, n) : u[t] = n))))
            }
        },
        css: function(e, t, n, i) {
            var r, o, s, a = C.camelCase(t);
            return Me.test(t) || (t = $e(a)),
        ...
        C.cssHooks[s] = {
            ...
            set: function(e, t, n) {
                ...
                return o && (i = J.exec(t)) && "px" !== (i[3] || "px") && (e.style[s] = t, t = C.css(e, s)),
                Qe(0, t, o)
            }
        }
    ...
    var Xe, Ge, Je, Ze, et = /^(?:toggle|show|hide)$/, tt = /queueHooks$/; function nt() {
    ...
    function st(o, e, t) {
        ...
        for (function(e, t) {
            var n, i, r, o, s;
            for (n in  e) if (r = t[i = C.camelCase(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = C.cssHooks[i]) && "expand" in  s) for (n in  o = s.expand(o), delete e[i], o) n in  e || (e[n] = o[n], t[n] = r);
            else t[i] = r
        } (c, u.opts.specialEasing); i < r; i++) if (n = st.prefilters[i].call(u, o, c, u.opts)) return C.isFunction(n.stop) && (C._queueHooks(u.elem, u.opts.queue).stop = C.proxy(n.stop, n)),
        n;
        return C.map(c, ot, u),
    ...
    C.Animation = C.extend(st, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, r = (e = C.isFunction(e) ? (t = e, ["*"]) : e.match(P)).length; i < r; i++) n = e[i],
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(d)) for (i in  f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = Q.get(e, "display")), "none" === (c = C.css(e, "display")) && (u ? c = u : (re([e], !0), u = e.style.display || u, c = C.css(e, "display"), re([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === C.css(e, "float") && (l || (h.done(function() {
                p.display = u
    ...
    C.fn.extend({
        ...
        stop: function(r, e, o) {
            ...
            this.each(function() {
                ...
                for (t = n.length; t--;) n[t].elem !== this || null != r && n[t].queue !== r || (n[t].anim.stop(o), e = !1, n.splice(t, 1)); ! e && o || C.dequeue(this, r)
            })
        },
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
    ...
    var at, lt = C.expr.attrHandle; C.fn.extend({
        attr: function(e, t) {
    ...
    C.each(C.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        lt[t] = function(e, t, n) {
            ...
            return n || (r = lt[o], lt[o] = i, i = null != s(e, t, n) ? o : null, lt[o] = r),
            i
        }
    });
    var ut = /^(?:input|select|textarea|button)$/i, ct = /^(?:a|area)$/i; function ft(e) {
    ...
    C.fn.extend({
        ...
        prop: function(e, t, n) {
            var i, r, o = e.nodeType;
            if (3 !== o && 8 !== o && 2 !== o) return 1 === o && C.isXMLDoc(e) || (t = C.propFix[t] || t, r = C.propHooks[t]),
        ...
        addClass: function(t) {
            ...
            if ("string" == typeof t && t) for (e = t.match(P) || []; n = this[l++];) if (r = ht(n), i = 1 === n.nodeType && " " + ft(r) + " ") {
    ...
    var gt = T.location, mt = C.now(), vt = /\?/; C.parseXML = function(e) {
        var t;
    ...
    var yt = /\[\]$/, _t = /\r?\n/g, bt = /^(?:submit|button|image|reset|file)$/i, wt = /^(?:input|select|textarea|keygen)/i; function Et(n, e, i, r) {
        var t;
        if (Array.isArray(e)) C.each(e, function(e, t) {
            i || yt.test(n) ? r(n, t) : Et(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, i, r)
        });
        else
        if (i || "object" !== C.type(e)) r(n, e);
        else
    ...
    var Tt = /%20/g, xt = /#.*$/, Ct = /([?&])_=[^&]*/, St = /^(.*?):[ \t]*([^\r\n]*)$/gm, Dt = /^(?:GET|HEAD)$/, At = /^\/\//, Nt = {}, It = {}, kt = "*/".concat("*"), Ot = x.createElement("a"); function Lt(o) {
        return function(e, t) {
    ...
    Ot.href = gt.href, C.extend({
        ...
        ajax: function(e, t) {
            ...
            t = t || {};
            var c, f, h, n, d, i, p, g, r, o, m = C.ajaxSetup({},
            t),
            v = m.context || m,
            ...
            if (_.promise(E), m.url = ((e || m.url || gt.href) + "").replace(At, gt.protocol + "//"), m.type = t.method || t.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(P) || [""], null == m.crossDomain) {
                ...
                try {
                    i.href = m.url,
                    i.href = i.href,
                    m.crossDomain = Ot.protocol + "//" + Ot.host != i.protocol + "//" + i.host
                } catch(e) {
                    m.crossDomain = !0
                }
            }
            ...
            function u(e, t, n, i) {
                ...
                p || (p = !0, d && T.clearTimeout(d), c = void 0, h = i || "", E.readyState = 0 < e ? 4 : 0, r = 200 <= e && e < 300 || 304 === e, n && (a = function(e, t, n) {
                    ...
                    if ("*" !== l && l !== o) {
                        if (! (s = u[l + " " + o] || u["* " + o])) for (r in  u) if ((a = r.split(" "))[1] === o && (s = u[l + " " + a[0]] || u["* " + a[0]])) { ! 0 === s ? s = u[r] : !0 !== u[r] && (o = a[0], c.unshift(a[1]));
                            break
                        }
    ...
    Ft = C.ajaxSettings.xhr(); m.cors = !!Ft && "withCredentials" in  Ft, m.ajax = Ft = !!Ft, C.ajaxTransport(function(r) {
        var o, s;
    ...
    var qt, Rt = [], Mt = /(=)\?(?=&|$)|\?\?/; C.ajaxSetup({
        ...
        var i, r, o, s = this,
        a = e.indexOf(" ");
        return -1 < a && (i = ft(e.slice(a)), e = e.slice(0, a)),
    ...
    function(t, r) {
        ...
        C.fn[t] = function(e) {
            return U(this, function(e, t, n) {
                var i;
                return C.isWindow(e) ? i = e : 9 === e.nodeType && (i = e.defaultView),
...
function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports, require("jquery")) : "function" == typeof define && define.amd ? define(["exports", "jquery"], t) : t((e = e || self).bootstrap = {},
    e.jQuery)
} (this, function(e, p) {
    "use strict";
    function i(e, t) {
...
default:
    ...
    k = function() {
        ...
        return e.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type) if (i.checked && this._element.classList.contains(E)) e = !1;
                    else {
    ...
    ae = function() {
        ...
        e.nextWhenVisible = function() { ! document.hidden && p(this._element).is(":visible") && "hidden" !== p(this._element).css("visibility") && this.next()
        },
        e.prev = function() {
        ...
        e._slide = function(e, t) {
            ...
            if (!this._triggerSlideEvent(l, r).isDefaultPrevented() && s && l) {
                this._isSliding = !0,
                c && this.pause(),
    ...
    function ct(n, i) {
        Object.keys(i).forEach(function(e) {
            var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && ut(i[e]) && (t = "px"),
            n.style[e] = i[e] + t
        })
    }
        ...
        modifiers: {
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    if (!e.instance.popper.contains(i)) return console.warn("WARNING: `arrow.element` must be child of its popper element!"),
                    e;
                    ...
                    e.arrowElement = i,
                    e.offsets.arrow = (Ke(n = {},
                    f, Math.round(_)), Ke(n, h, ""), n),
                    e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(p, g) {
                    ...
                    return b.forEach(function(e, t) {
                        ...
                        (s || f || d) && (p.flipped = !0, (s || f) && (v = b[t + 1]), d && (_ = "end" === (n = _) ? "start" : "start" === n ? "end" : n), p.placement = v + (_ ? "-" + _ : ""), p.offsets.popper = $e({},
                        p.offsets.popper, tt(p.instance.popper, p.offsets.reference, p.placement)), p = it(p.instance.modifiers, p, "flip"))
                    }),
                    p
                },
                behavior: "flip",
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    A = void 0,
                    N = void 0;
                    if (N = "bottom" === C ? "HTML" === w.nodeName ? -w.clientHeight + x.bottom : -E.height + x.bottom : x.top, A = "right" === S ? "HTML" === w.nodeName ? -w.clientWidth + x.right : -E.width + x.right : x.left, b && D) T[D] = "translate3d(" + A + "px, " + N + "px, 0)",
                    T[C] = 0,
                    T[S] = 0,
    ...
    Yt = function() {
        ...
        e.show = function() {
            if (! (this._element.disabled || p(this._element).hasClass(Nt) || p(this._menu).hasClass(It))) {
                ...
                p(n).trigger(t),
                t.isDefaultPrevented() || (p(this._menu).toggleClass(It), p(n).toggleClass(It).trigger(p.Event(At.SHOWN, e)))
            }
        },
        e.hide = function() {
            if (!this._element.disabled && !p(this._element).hasClass(Nt) && p(this._menu).hasClass(It)) {
                ...
                n = u._getParentFromElement(this._element);
                p(n).trigger(t),
                t.isDefaultPrevented() || (p(this._menu).toggleClass(It), p(n).toggleClass(It).trigger(p.Event(At.HIDDEN, e)))
            }
        },
        e.dispose = function() {
        ...
        e._getConfig = function(e) {
            return e = l({},
            this.constructor.Default, p(this._element).data(), e),
        ...
        e._getPlacement = function() {
            ...
            t = Ut;
            return e.hasClass(kt) ? (t = Wt, p(this._menu).hasClass(jt) && (t = Bt)) : e.hasClass(Ot) ? t = $t : e.hasClass(Lt) ? t = Qt : p(this._menu).hasClass(jt) && (t = Kt),
            t
        },
            ...
            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var t = [].slice.call(document.querySelectorAll(Pt)), n = 0, i = t.length; n < i; n++) {
                ...
                if (e && "click" === e.type && (s.clickEvent = e), o) {
                    ...
                    if (p(r).hasClass(It) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                        ...
                        p(r).trigger(l),
                        l.isDefaultPrevented() || ("ontouchstart" in  document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), p(a).removeClass(It), p(r).removeClass(It).trigger(p.Event(At.HIDDEN, s)))
                    }
                }
            }
        },
    ...
    mn = function() {
        ...
        e.show = function(e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(nn.CLICK_DISMISS, dn, function(e) {
                    return t.hide(e)
        ...
        r._jQueryInterface = function(n, i) {
            return this.each(function() {
                ...
                t = l({},
                en, p(this).data(), "object" == typeof n && n ? n : {});
    ...
    p(document).on(nn.CLICK_DATA_API, hn, function(e) {
        ...
        var r = p(t).data(Gt) ? "toggle" : l({},
        p(t).data(), p(this).data());
    ...
    Un = function() {
        ...
        e._getConfig = function(e) {
            ...
            return Object.keys(t).forEach(function(e) { - 1 !== An.indexOf(e) && delete t[e]
            }),
            "number" == typeof(e = l({},
    ...
    Ti = function() {
        ...
        e._activate = function(t) {
            ...
            n.hasClass(fi) ? (n.closest(yi).find(bi).addClass(hi), n.addClass(hi)) : (n.addClass(hi), n.parents(pi).prev(gi + ", " + vi).addClass(hi), n.parents(pi).prev(mi).children(gi).addClass(hi)),
    ...
    p(document).on(Di.CLICK_DATA_API, Fi, function(e) {
        e.preventDefault(),
        Mi._jQueryInterface.call(p(this), "show")
    }),
    ...
    Zi = function() {
        ...
        e._getConfig = function(e) {
            return e = l({},
            Gi, p(this._element).data(), "object" == typeof e && e ? e : {}),
